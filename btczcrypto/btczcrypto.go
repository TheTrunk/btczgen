// Standalone library to generate btcz addresses
package btczcrypto
...
import (
	...
	"github.com/TheTrunk/btczgen/base58"
...
type btczWallet struct {
	Passphrase string         `json:"passphrase"`
	HexSeed    string         `json:"hexSeed"`
	Addresses  []btczAddress `json:"addresses"`
	RequestId  string         `json:"requestId"`
}

type btczAddress struct {
...
func getAddressFromPassphrase(mainnet bool, passphrase string, position uint32) (btczAddress, error) {
	var returnValue btczAddress
...
func CreateWallet(mainnet bool, numberOfAddressesToGenerate int) (btczWallet, error) {
	var wallet btczWallet
...
func GetWalletFromPassphrase(mainnet bool, passphrase string, position uint32) (btczWallet, error) {
	var result btczWallet
	var address btczAddress
